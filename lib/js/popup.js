  ...
  $("#doLoginBtn").click(function(e){
    ...
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR){
        ...
        setKey("email", $("#sign_in_email").val())
        showCurrentUserView()
      },
  ...
  $("#doRegisterBtn").click(function(e) {
    ...
    $.ajax({
      ...
      success: function (data, textStatus, jqXHR) {
        ...
        $("#danger-box").show()
          .find('.message').html($.parseJSON(jqXHR.responseText).message)
      },
      error: function (jqXHR, textStatus, errorThrown) {
        $("#danger-box").show()
          .find('.message').html($.parseJSON(jqXHR.responseText).error)
  ...
  $("#forgotBtn").click(function(e) {
    ...
    $.ajax({
      ...
      success: function (data, textStatus, jqXHR) {
        showWelcomeView()
        $("#danger-box").show()
          .find('.message').html("Reset password link sent to email")
      },
      error: function (jqXHR, textStatus, errorThrown) {
        $("#danger-box").show()
          .find('.message').html($.parseJSON(jqXHR.responseText).error)
...
function showCurrentUserView(){
  ...
  getKey("email", function(value){
    if (value != null){
      $("#currentUser").html(value)
    }
  })
}
